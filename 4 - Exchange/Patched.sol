...
contract CurrencyExchange {
  ...
  function buyEUR(uint256 numEUR) public payable {
    require(numEUR <= 100000000000000, "You can't buy more than 100.000.000.000.000 EUR");
  ...
  function buyUSD(uint256 numUSD) public payable {
      require(numUSD <= 100000000000000, "You can't buy more than 100.000.000.000.000 USD");
