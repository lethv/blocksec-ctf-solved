...
contract Roulette {
    ...
    function betOnRed() public payable checkBet humanPlayer {
        betRed += msg.value;
    }

    function betOnBlack() public payable checkBet humanPlayer { 
        betBlack += msg.value;
    }

    function playRoulette() public checkPlay humanPlayer returns (string memory) {
